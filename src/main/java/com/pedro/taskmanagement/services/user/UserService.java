...
public class UserService {
    ...
    public User createUser(UserRegisterDTO obj) {
        ...
        User user = new User(null, obj.getName(), obj.getUsername(), passwordEncoder.encode(obj.getPassword()), obj.getEmail());
        return repository.save(user);
    }

    public JwtTokenDTO authenticateUser(UserLoginDTO obj) {
        UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken = new UsernamePasswordAuthenticationToken(obj.getEmail(), obj.getPassword());
